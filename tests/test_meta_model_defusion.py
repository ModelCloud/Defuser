...
META_MODEL_CASES = [
    ...
    },
    {
        ...
        "mode": "convert",
        "model_module": "transformers.models.qwen4_exp.modeling_qwen4_exp",
        "model_class": "Qwen4ExpForConditionalGeneration",
        "config_module": "transformers.models.qwen4_exp.configuration_qwen4_exp",
        "config_class": "Qwen4ExpConfig",
        "target_class_paths": ("transformers.models.qwen4_exp.modeling_qwen4_exp.Qwen4ExpTextExperts",),
        "validator": "experts",
        "min_targets": 2,
    },
    {
